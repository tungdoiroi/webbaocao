...
<%--                    &lt;%&ndash;                        <select name="CategoryID" class="form-control" required>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                            <c:forEach var="o" items="${listC}">&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                                <option value="${o.id}">${o.name}</option>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                            </c:forEach>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                        </select>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                    <div class="form-group">&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                        <label>Seller</label>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                        <select name="SellerID" class="form-control" required>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                            <c:forEach var="o" items="${listS}">&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                                <option value="${o.id}">${o.user}</option>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                            </c:forEach>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                        </select>&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--                    <div class="form-group">--%>
